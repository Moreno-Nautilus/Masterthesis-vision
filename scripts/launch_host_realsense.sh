...
VIZ2_CMD='python3 -m src.perception.ros.learn_runners.visualize_pipeline --node-name foundationpose_external_visualizer_realsense_1 --cam-id realsense_1 --rgb-topic /realsense_1/camera/color/image_raw --camera-info-topic /realsense_1/camera/color/camera_info --debug-topic /perception/fp/debug_frame/realsense_1 --raw-out-topic /perception/fp/rgb_raw/realsense_1_external --sam-out-topic /perception/fp/sam_overlay/realsense_1_external --dino-out-topic /perception/fp/dino_overlay/realsense_1_external --pose-out-topic /perception/fp/pose_overlay/realsense_1_external --track-out-topic /perception/fp/track_overlay/realsense_1_external --output-scale 0.5 --max-sync-dt-s 999'

VIZ3_CMD='python3 -m src.perception.ros.learn_runners.visualize_pipeline --node-name foundationpose_external_visualizer_realsense_2 --cam-id realsense_2 --rgb-topic /realsense_2/camera/color/image_raw --camera-info-topic /realsense_2/camera/color/camera_info --debug-topic /perception/fp/debug_frame/realsense_2 --raw-out-topic /perception/fp/rgb_raw/realsense_2_external --sam-out-topic /perception/fp/sam_overlay/realsense_2_external --dino-out-topic /perception/fp/dino_overlay/realsense_2_external --pose-out-topic /perception/fp/pose_overlay/realsense_2_external --track-out-topic /perception/fp/track_overlay/realsense_2_external --output-scale 0.5 --max-sync-dt-s 999'
