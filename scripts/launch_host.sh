...
SRC_HOST='source /opt/ros/humble/setup.bash && source "$HOME/zed_ros2_ws/install/setup.bash" && source "$HOME/franka_ros2_ws/install/setup.bash"'
SRC_ROS='source /opt/ros/humble/setup.bash'
