...
bool fp_debug_msgs__msg__debug_mask_crop__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fp_debug_msgs.msg._debug_mask_crop.DebugMaskCrop", full_classname_dest, 48) == 0);
  }
  fp_debug_msgs__msg__DebugMaskCrop * ros_message = _ros_message;
  {  // width
...
{
  /* NOTE(esteve): Call constructor of DebugMaskCrop */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fp_debug_msgs.msg._debug_mask_crop");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DebugMaskCrop");
